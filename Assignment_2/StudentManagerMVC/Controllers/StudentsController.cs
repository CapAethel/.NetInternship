...
namespace StudentManagerMVC.Controllers
{
    public class StudentsController : Controller
    {
        ...
        // GET: Students
        public async Task<IActionResult> Index(string filter, int? year)
        {
            // Query all students by default
            ...
            {
                case "Male":
                    students = students.Where(s => s.Gender == "Male");
                    break;
                case "Oldest":
                ...
                case "BirthYear":
                    if (year.HasValue)
                    {
                        students = students.Where(s => s.DateOfBirth.Year == year.Value);
                    }
                    break;
                case "Hanoi":
                    students = students.Where(s => s.PlaceOfBirth == "Ha Noi");
                    break;
            }
